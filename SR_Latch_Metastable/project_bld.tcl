...
#append src_files   [glob src/*.v]

set    const_files [glob const/*.xdc]
#append const_files [glob const/*.tcl]

set    sim_files   [glob sim/*.sv]
#append sim_files   [glob sim/*.v]
...
# Create project
#################################################
create_project ${proj_name} ./run/${proj_name} -part xc7a100tcsg324-1
...
add_files -norecurse -fileset $obj $const_files

# Set 'constrs_1' file filetypes
foreach file_name $const_files {
  set file_name [file normalize $file_name]
...
# Set the final implementation properties
set obj [get_runs impl_1]
